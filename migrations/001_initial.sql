CREATE TABLE entries (id INTEGER PRIMARY KEY AUTOINCREMENT,content TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP, "userId" TEXT references "user" ("id") on delete cascade);
